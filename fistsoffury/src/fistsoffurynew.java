...
public class fistsoffurynew extends JFrame implements KeyListener, ActionListener // used to so that we can use keys and motion etc. 
{
...
// the following are variables, booleans, colors, color matrices that i established so that I can use them thorugh out the program with ease
    ...
    public fistsoffurynew() //start constructor
    {
